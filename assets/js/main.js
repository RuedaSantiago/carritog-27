...
function eventListenersLoader() {
    ...
    document.addEventListener("DOMContentLoaded", () => {
        // Si el localStorage tiene info, entonces, igualamos carProducts con la info del LocalStorage. Pero, si el LocalStorage esta vacío, entonces, carProducts es igual a un array vacío.

        carProducts = JSON.parse(localStorage.getItem("car")) || []; carElementsHTML()
    })
}
